...
def train():
    ...
    train_data_dir = path.join('data', 'train')  # <Path_To_Training_folder>
    validation_data_dir = path.join('data', 'validation')  # <Path_To_Valid_folder>
    nb_train_samples = 80
    ...
    train_generator, validation_generator, checkpoint, reduce_lr = prepare_data(train_data_dir=train_data_dir,
...
def prepare_data(train_data_dir, validation_data_dir, img_height, img_width, batch_size):
    ...
    return train_generator, validation_generator, checkpoint, reduce_lr
