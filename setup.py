...
if __name__ == "__main__":
    ...
    setup(
        ...
        data_files=[
            ...
            (
                _url_checksums_install_dir(),
                list(map(_url_checksums_join, listdir(_url_checksums_join()))),
            ),
            (
                _model_configs_install_dir(),
                list(map(_model_configs_join, listdir(_model_configs_join()))),
            ),
        ],
    )
